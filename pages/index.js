            ...
            <header className="site-header">
                <div className="header-inner container">
                    <a href="https://splendidmoving.com" className="header-logo" aria-label="Splendid Moving — back to main site">
                        <img src="https://splendidmoving.com/assets/images/Brand Logo.png" alt="Splendid Moving" height="46" />
                    </a>
                    <a href="tel:3236452636" className="header-phone">
                ...
                <div className="booking-container container">
                    ...
                    <div className="booking-panel" id="panel-date" role="region" aria-label="Select a date">
                        ...
                        <div className="office-notice">
                            ...
                            <p><strong>Don&apos;t see your preferred date?</strong> We can often accommodate requests not shown here — including today and tomorrow. Call or text <a href="tel:3236452636">(323) 645-2636</a> or email <a href="mailto:info@splendidmoving.com">info@splendidmoving.com</a>.</p>
                        </div>
                    ...
                    <div className="booking-panel" id="panel-time" role="region" aria-label="Select an arrival window">
                        ...
                        <div className="office-notice" id="slots-office-notice">
                            ...
                            <p><strong>Need a different time?</strong> Contact our office directly — we may have additional availability not shown here. Call or text <a href="tel:3236452636">(323) 645-2636</a> or email <a href="mailto:info@splendidmoving.com">info@splendidmoving.com</a>.</p>
                        </div>
                        <div className="panel-actions panel-actions--left">
                    ...
                    <div className="booking-panel" id="panel-success" role="region" aria-label="Booking confirmed">
                        <div className="success-screen">
                            ...
                            <p className="success-contact">Questions? Call us at <a href="tel:3236452636">(323) 645-2636</a></p>
                        </div>
                    </div>
